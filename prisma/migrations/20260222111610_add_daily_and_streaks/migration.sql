...
INSERT INTO "new_User" ("balance", "bank", "channelId", "coinflipsPlayed", "coinflipsWon", "createdAt", "currentStreak", "id", "lastCoinflip", "lastRob", "lastRobbed", "lastStreakDate", "lastWork", "longestStreak", "ownedItems", "recentRobTargets", "robsAttempted", "robsFailed", "robsSucceeded", "slackId", "timesWorked", "totalEarned", "totalLostToRobbers", "totalStolen", "updatedAt", "username") SELECT "balance", "bank", "channelId", "coinflipsPlayed", "coinflipsWon", "createdAt", "currentStreak", "id", "lastCoinflip", "lastRob", "lastRobbed", "lastStreakDate", "lastWork", "longestStreak", "ownedItems", "recentRobTargets", "robsAttempted", "robsFailed", "robsSucceeded", "slackId", "timesWorked", "totalEarned", "totalLostToRobbers", "totalStolen", "updatedAt", "username" FROM "User";
DROP TABLE "User";
